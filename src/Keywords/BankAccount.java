...
public class BankAccount {
    ...
    public BankAccount(String accountHolderName, String accountNumber, double balance) {
        this.accountHolderName = this.resolveName(accountHolderName); // optional use of a method to show 'this'
    ...
    // Optional method to demonstrate 'this' keyword
    private String resolveName(String name) {
        return this.accountHolderName != null ? this.accountHolderName : name;
    }
